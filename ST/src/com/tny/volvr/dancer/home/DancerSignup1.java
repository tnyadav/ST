...
public class DancerSignup1 extends Activity {
	...
	private void next()
	{
		...
		// new UploadFile(context, strImgepath).execute("");

		//		
		//			
		/*	SignupBean.mUserName=strUsername;
			SignupBean.mPassword=strPassword;
		    SignupBean.mEmail=strEmail;
		 */


		Intent i=new Intent(context, DancerSignup2.class);
		startActivity(i);
	}
	...
	protected void onPause() {
		...
		editor.putString("mPassword", strPassword);
		editor.putString("mEmail", strEmail);
		editor.putString("mPicture", strImgepath);
		editor.putString("mContactNo", strcontactno);
		editor.commit();
