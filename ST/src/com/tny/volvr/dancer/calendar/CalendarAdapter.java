...
public class CalendarAdapter extends BaseAdapter {
	...
	private ArrayList<String> itemsDate;
	// references to our items
	public String[] days;
	public CalendarAdapter(Context c, Calendar monthCalendar, ArrayList<String> itemsDate) {
		month = monthCalendar;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String dateStr=month.get(Calendar.YEAR)+"-"+monthValue+"-"+dayValue;
		for (int i = 0; i < itemsDate.size(); i++) {
			if(itemsDate.get(i).equalsIgnoreCase(dateStr))
			{
